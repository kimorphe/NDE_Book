...
\begin{equation}
	I(x)=
	\left. a_{11}\left(t-\frac{2L}{c}\right)
	\right|_{t=\frac{2x}{c}}
	=
...
\begin{equation}
	...
	\label{eqn:XXX_18}
\end{equation}
となる．この例からも分かるように，デコンボリューションで得られる信号は，観測波形よりは
パルス幅が圧縮されるとしても，帯域幅$\omega_b$に応じた有限な幅を持つものになる.
また，実際の計測では， 参照波形と画像化に用いるAスキャン波形の周波数スペクトルが
完全に一致することは無く，このことからもデコンボリューションは完全なものとならない．
デコンボリューションの効果は，画像化に用いる波形とどれだけ近い参照波形を用意する
ことができるかにかかっており，その成否は，画像化すべききずの位置や性状,散乱特性が
どの程度事前に分かっているかに依存する.
\paragraph{時間反転法}
