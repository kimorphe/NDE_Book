...
以下では簡単のため， 図\ref{fig:arrayM}を参照し，無限領域内部に存在する欠陥の形状再構成について
...
\begin{equation}
	...
	\label{eqn:}
\end{equation}
で，$a_{11}(t)$一つだけである．${\cal D}_1$から得られる画像は式(\ref{eqn:saft})より
\begin{equation}
